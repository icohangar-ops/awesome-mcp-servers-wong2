...
- **[CHP Spend Gate](https://github.com/icohangar-ops/cubiczan-chp-mcp)** - Spend approval gate for AI agents: budget caps, per-asset limits, human-in-the-loop thresholds, and a signed audit hash.

...
- **[Agent Conductor](https://github.com/icohangar-ops/agent-conductor)** - Parses AGENTS.md contracts and SKILL.md registries, and gates decisions with an optional adversarial pass.
